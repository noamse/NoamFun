...
%   r = ut.sendTelegramImageAndWaitForReply("img.png", chatID, timeoutSeconds, botToken)
    ...
    arguments
        imagePath (1,:) char
        chatID (1,:) char = '7700572066';          % default from TELEGRAM_CHAT_ID
        timeoutSeconds (1,1) double = 21000
        botToken (1,:) char = '8133686636:AAHUEuL9g_G1_UIdGRY2MFWBhK9cH8GhoWg';        % default from TELEGRAM_BOT_TOKEN
    end
