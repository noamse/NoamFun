function [JPL,ParGrid]= generatePargridData(numbermp,minPeriod,maxPeriod,Args)
arguments
    numbermp;
    minPeriod=14/24;
    maxPeriod= 350/24;
    Args.OverSampling = 20;
end
...
%[MeanEpochLTC,MeanEpoch,MeanResAL,MeanResAL_err,MeanResAC,MeanScanPA,Lat,Long,distance] = ...
%    BinaryAst.readAstroidAstCat(AsteroidNumber,GAIADR2sso_obs,GAIADR2sso_orbit,GAIADR2sso_orbitres);
