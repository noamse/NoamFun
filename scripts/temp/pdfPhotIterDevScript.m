...
RefTab = ml.kmt.read_kmt9k_cat(impth,'MaxMag',18.2);
Isort = (sort(RefTab(:,3)));
...
%%
[Cat,~,ImSub]=  ml.pipe.imProc.psfFitPhotIter(Im.copy(),'XY',[ogle_cat.getCol({'X','Y'})],'PSF',Im.PSF...
    ,'MAG',ogle_cat.getCol('I'),'NRefMagBin',6,'FitRadius',2.5,...
    'HalfSize',10,'UseSourceNoise','all','PSFfitMaxIter',10,'PSFfitConvThresh',1e-4,...
    'RecenterPSF',false,'ReCalcBack',true);
